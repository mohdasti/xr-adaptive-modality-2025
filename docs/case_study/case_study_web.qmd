...
# Use project_root from setup chunk (set in setup chunk)
qmd_dir <- file.path(project_root, "docs", "case_study")
images_dir <- file.path(qmd_dir, "images")
if (!dir.exists(images_dir)) dir.create(images_dir, recursive = TRUE)

# Source file path (relative to project_root)
src_file <- file.path(project_root, "outputs", "LBA", "lba_trace_plot.png")
